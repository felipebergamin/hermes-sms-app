...
@section('imports')
    ...
    <script src="/js/controller/visualizar_lote.js"></script>
@endsection
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- row tiles -->
            <div class="row" ng-app="hermes_app" ng-controller="visualizar_lote">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <form>
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-file-text-o"></i></span>
                                    <input class="form-control" placeholder="Filtrar por descrição" type="text"
                                        ng-model="filters.descricao">
                                </div>
                                <br>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input class="form-control" placeholder="Filtrar por remetente"
                                        ng-model="filters.user.name">
                                </div>
                                <br>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr ng-repeat="lote in lista_lotes | startFrom:pagination.current_page*pagination.page_length | limitTo:pagination.page_length | filter:filters">
                                        <td>@{{ lote.descricao }}</td>
                                        <td>@{{ lote.user.name }}</td>
                                        <td>@{{ lote.sms_count }}</td>
                                        <td>@{{ lote.created_at*1000 | date:'dd/MM/yyyy - HH:mm' }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div><!-- /.box-body -->
